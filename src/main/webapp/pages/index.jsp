...
<head>
    ...
    <script src="../plugin/jquery/jquery-3.3.1.min.js" type="text/javascript"></script>
    <script src="../js/util.js" type="text/javascript"></script>
    <link href="../plugin/font-awesome-4.6.3/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>

    <link href="../plugin/bootstrap/bootstrap.min.css" rel="stylesheet" type="text/css"/>
    <link href="../plugin/material/mdb.min.css" rel="stylesheet" type="text/css"/>
    <link href="../plugin/css/nav_mn.css" rel="stylesheet" type="text/css"/>
    <link href="../plugin/css/login.css" rel="stylesheet" type="text/css"/>
</head>
...
<div class=" fixed-bottom ">
    <div w3-include-html="includes/footer"></div>
</div>
...
<script src="../plugin/material/mdb.min.js" type="text/javascript"></script>
<!-- Modal -->
